...
<table style="position:absolute;top:15%;left:20%; border-style:solid;" border="1"  width="850" height="900" cellspacing="3" cellpadding="3">
    <tr height="60"><td style="font-size:30px"colspan="5" align="center">水果类：</td></tr>
    ...
    <tr  height="60" align="center">
        <form action="dofruitCar.jsp?action=buy&id=0" method="post" name="form1">
            <td> <img  src="/untitled5/web/images/苹果.jpg" height="152" width="200">   </td>
            <td style="font-size:40px">苹果</td>
            <td style="font-size:35px">2.8</td>
    ...
    <tr  height="60" align="center">
        <form action="dofruitCar.jsp?action=buy&id=1" method="post" name="form1">
            <td>  <img  src="/untitled5/web/images/香蕉.jpg" height="152" width="200">  </td>
            <td style="font-size:40px">香蕉</td>
            <td style="font-size:35px">3.1</td>
            <td ><input style="width:130px;height:40px" size="15" type="text" name="aa">
            <td ><input style="font-size:25px;height:50px;width:100px;" type="submit" name="buy"  value="购买"></td>
        </form>
    </tr>
    ...
    <tr  height="60" align="center">
        <form action="dofruitCar.jsp?action=buy&id=2" method="post" name="form1">
            <td> <img  src="/untitled5/web/images/梨.jpg" height="152" width="200">   </td>
            <td style="font-size:40px">梨</td>
            <td style="font-size:35px">2.5</td>
            <td ><input style="width:130px;height:40px" size="15" type="text" name="aa">
            <td ><input style="font-size:25px;height:50px;width:100px;" type="submit" name="buy"  value="购买"></td>
        </form>
    </tr>
    ...
    <tr  height="60" align="center">
        <form action="dofruitCar.jsp?action=buy&id=3" method="post" name="form1">
            <td> <img  src="/untitled5/web/images/橘子.jpg" height="152" width="200">   </td>
            <td style="font-size:40px">橘子</td>
            <td style="font-size:35px">2.3</td>
            <td ><input style="width:130px;height:40px" size="15" type="text" name="aa">
            <td ><input style="font-size:25px;height:50px;width:100px;" type="submit" name="buy"  value="购买"></td>
        </form>
    </tr>
    ...
    <div style="position:absolute;top:1180px;left:20%";><a href="ele shop.jsp"><input style="height:60px;width:150px;" type="button" value='跳转到电器类商店'></a></div>
